...
namespace api.DTOs
{
    public class ResolvedOriginalDto
    {
        ...
        [JsonPropertyName("chassis_span1")]
        public double? chassis_span1 { get; set; }

        [JsonPropertyName("chassis_span2")]
        ...
        [JsonPropertyName("is_original_spec")]
        ...
        [JsonPropertyName("pic_before_hst_file_name")]
        public string? pic_before_hst_file_name { get; set; }

        [JsonPropertyName("tool_key_id")]
        public int? tool_key_id { get; set; }

        [JsonPropertyName("tool_ref_spec_id")]
        public int? tool_ref_spec_id { get; set; }

        [JsonPropertyName("tool_key_id_original")]
        public int? tool_key_id_original { get; set; }
    }
}
