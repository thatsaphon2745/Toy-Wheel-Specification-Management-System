          ...
          <div className="mb-8">
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              ...
              <SpecField
                ...
                icon={Settings}
              />
              {/* <SpecField label="Machine No" value={detailData.machine_no} icon={Settings} /> */}
              <SpecField label="Source" value={detailData.source} icon={Info} />
              <div className="group relative">
                <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`p-1 rounded-full ${
                        detailData.is_original_spec
                          ? "bg-green-100"
                          : "bg-gray-100"
                      }`}
                    >
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-[12%] left-[50%] transform -translate-x-1/2">
                    <div className="bg-white/80 text-gray-800 text-xs font-semibold px-3 py-1.5 rounded-full shadow-md">
                      {detailData.chassis_span1}" , {detailData.chassis_span2}"
                    </div>
                  </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              <div className="space-y-3">
                <RangeField
                  label="Chassis Span"
                  min={detailData.chassis_span1}
                  max={detailData.chassis_span2}
                  unit={`"`}
                  icon={Ruler}
                />
                <RangeField
